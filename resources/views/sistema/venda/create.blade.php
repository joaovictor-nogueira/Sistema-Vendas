    ...
    <div class="container py-4">
        <div class="card shadow rounded">
            <div class="card-header bg-primary text-white py-3">
                <h4 class="mb-0"><i class="bi bi-cart-plus me-2"></i>Nova Venda</h4>
            </div>
                                        ...
                                        <div class="produto row g-3 align-items-end mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <select name="produtos[0][id]"
                                                    class="form-select produto-select @error('produtos.0.id') is-invalid @enderror"
                                                    onchange="atualizarValor(this)" required>
                                                    <option selected disabled value="">Selecione um produto...
                                                    </option>
                                                ...
                                                <p class="invalid-feedback">{{ $errors->first('produtos.0.id') }}</p>
                                            </div>
                                            <div class="col-md-1">
                                                <label class="form-label">Qtd <span class="text-danger">*</span></label>
                                                <input type="number" name="produtos[0][quantidade]" placeholder="Qtd"
                                                    class="form-control @error('produtos.0.quantidade') is-invalid @enderror"
                                                    min="1" value="{{ old('produtos.0.quantidade', 1) }}"
                                                    required>
                                                <p class="invalid-feedback ">
                                                    {{ $errors->first('produtos[0][quantidade]') }}
                                                </p>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Valor Unitário <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <span class="input-group-text">R$</span>
                                                    <input type="text" name="produtos[0][valor_unitario]"
                                                        placeholder="Valor Unitário"
                                                        class="form-control @error('produtos.0.valor_unitario') is-invalid @enderror"
                                                        value="{{ old('produtos.0.valor_unitario') }}" required>
                                                </div>
                                                <p class="invalid-feedback ">
                                                    {{ $errors->first('produtos.0.valor_unitario') }}
                                                </p>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Valor Total</label>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="forma_pagamento" id="forma_pagamento"
                                                    ...
                                                    <option selected disabled value="">Selecione a forma de
                                                        pagamento...</option>
                                                    <option value="Cartão de Crédito"
                                                        {{ old('forma_pagamento') == 'Cartão de Crédito' ? 'selected' : '' }}>
                                                        Cartão de Crédito</option>
                                                    <option value="Cartão de Débito"
                                                        {{ old('forma_pagamento') == 'Cartão de Débito' ? 'selected' : '' }}>
                                                        Cartão de Débito</option>
                                                    <option value="Pix"
                                                        {{ old('forma_pagamento') == 'Pix' ? 'selected' : '' }}>Pix
                                                    </option>
                                                    <option value="Dinheiro"
                                                        {{ old('forma_pagamento') == 'Dinheiro' ? 'selected' : '' }}>
                                                        Dinheiro</option>
                                                    <option value="Outros"
                                                        {{ old('forma_pagamento') == 'Outros' ? 'selected' : '' }}>Outros
                                                    </option>
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="tipo_pagamento" id="tipo_pagamento"
                                                    ...
                                                    <option selected disabled value="">Selecione o tipo de
                                                        pagamento...</option>
                                                    <option value="avista"
                                                        {{ old('tipo_pagamento') == 'avista' ? 'selected' : '' }}>À Vista
                                                    </option>
                                                    <option value="Parcelado"
                                                        {{ old('tipo_pagamento') == 'Parcelado' ? 'selected' : '' }}>
                                                        Parcelado</option>
                                                </select>
                                            ...
                                            <div id="parcelas-container" class="mt-3"
                                                style="{{ old('tipo_pagamento') == 'Parcelado' ? '' : 'display: none;' }}">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" id="qtd_parcelas" name="qtd_parcelas"
                                                        ...
                                                        min="1" max="12"
                                                        value="{{ old('qtd_parcelas', 1) }}" onchange="gerarParcelas()">
                                                    <span class="input-group-text">x</span>
                                                </div>
                                                <p class="invalid-feedback d-block">{{ $errors->first('qtd_parcelas') }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
